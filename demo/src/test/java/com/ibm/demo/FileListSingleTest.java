...
public class FileListSingleTest extends TestCase{
	...
	public void test_add_1(){
		List<TestBean> lst = new FileListSingleImpl<TestBean>(path);
	...
	public void test_addAll_1(){
		...
		List<TestBean> lst2 = new FileListSingleImpl<TestBean>(path);
		lst2.add(tb5);
		lst2.add(tb6);
	...
	public void test_iterator(){
		...
		Iterator<TestBean> itr = ((FileListSingleImpl)lst).iterator();
		int cnt = 1;
		while(itr.hasNext()){
	...
	public void test_add_CAST(){
		...
		try{
			lst = new FileListSingleImpl(path);
			lst.add(tb2);
	...
	public void test_add_NoSerializable(){
		...
		List<TestBean3> lst = new FileListSingleImpl<TestBean3>(path);
		try{
		lst.add(tb3);
	...
	public void test_StringTest(){
		List<String> lst = new FileListSingleImpl<String>(path);
